          ...
          <div className='row'>
            <div className='col'>
              <div className='hire'>
                <h2>JOIN OUR TEAM</h2>
                <br></br>
                <h4>Working at Direct Admission Global is more than just a job.</h4>
                <br></br>
                  <h5>It's Chance to be a part of a global Community where opportunities are offered Skills are Nurtured & Excellence is rewarded.</h5>
